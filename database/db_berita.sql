...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 13, 2023 at 02:35 AM
...
(35, 'Olimpiade Musim Panas 2020: Prestasi Memukau dan Rekor Baru Dibuat', 'olahraga-5.jpeg', 1, 'Olimpiade Musim Panas 2020 menyita perhatian dunia olahraga dengan serangkaian prestasi luar biasa dan pencapaian rekor. Altet A dari Negara B mencatatkan rekor baru dalam lomba lari 100 meter putra, menorehkan waktu yang mengesankan dan menyabet medali emas.', '2023-12-03', 10, 3, 0),
...
INSERT INTO `contact` (`id_contact`, `name_contact`, `email_contact`, `subject_contact`, `message_contact`) VALUES
(1, 'Nuraini', 'nuraini@gmail.com', 'Berita ', '.'),
(2, 'Intan ', 'intanpermata2287@gmail.com', 'Berita ', 'pengajuan');
...
('C0002', 'Intan Nuraini', 'intanpermata2287@gmail.com', 'intan', '$2y$10$OA3dGGW/SvkILfhmD4FGQ.XLCQBi9JzksuGQM00AXggwEqLaNOXrS', '+6282242536479'),
('C0003', 'Nuraini', 'nuraini@gmail.com', 'aini', '$2y$10$znL.cu6GlKPQ4IeZ.22LwevswCWOCV3KM/RZvKL6DLA3QPB5KXlzy', '+628242536765');
...
(795, 13, 'Desi', 'musim politikk', '2023-12-12 15:51:02'),
(796, 23, 'Tristan', 'ngga sabarr beneran apa ngga', '2023-12-13 01:21:25'),
(797, 23, 'lili', '🥳🥳🥳🥳', '2023-12-13 01:22:05');
...
INSERT INTO `like_berita` (`id`, `id_customer`, `id_berita`) VALUES
(167, 'C0002', 36),
(168, 'C0002', 13),
(172, 'C0003', 13),
(173, 'C0003', 12);
...
--
ALTER TABLE `berita`
  MODIFY `id_berita` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
...
--
ALTER TABLE `komen`
  MODIFY `id_komen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=798;
...
--
ALTER TABLE `penulis`
  MODIFY `id_penulis` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
ALTER TABLE `like_berita`
  ...
  ADD CONSTRAINT `like_berita_ibfk_2` FOREIGN KEY (`id_berita`) REFERENCES `berita` (`id_berita`) ON DELETE CASCADE;
COMMIT;
